...
const WALLETSHELL_VERSION = app.getVersion() || '0.0.2';
const SERVICE_FILENAME =  (platform === 'win32' ? 'Pet-service.exe' : 'Pet-service' );
...
const DEFAULT_TITLE = 'Petcoin Wallet';
const DEFAULT_TRAY_TIP = 'Petcoin Wallet';
const PUBLIC_NODES_URL = 'https://raw.githubusercontent.com/javalopes/Petcoin-nodes/master/Petcoin-nodes.json';
const FALLBACK_NODES = [
    '35.196.226.203:11998',
    '62.75.138.56:11998',
];
const DEFAULT_SETTINGS = {
    ...
    daemon_host: '35.196.226.203',
    daemon_port: 11998,
    pubnodes_date: null,
    pubnodes_data: FALLBACK_NODES,
    pubnodes_custom: ['127.0.0.1:11998'],
    tray_minimize: false,
    tray_close: false,
    darkmode: true
};
